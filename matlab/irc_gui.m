function varargout = irc_gui(varargin)
% IRC_GUI MATLAB code for irc_gui.fig
%      IRC_GUI, by itself, creates a new IRC_GUI or raises the existing
%      singleton*.
%
%      H = IRC_GUI returns the handle to a new IRC_GUI or the handle to
%      the existing singleton*.
%
%      IRC_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IRC_GUI.M with the given input arguments.
%
%      IRC_GUI('Property','Value',...) creates a new IRC_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before irc_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to irc_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help irc_gui

% Last Modified by GUIDE v2.5 02-Aug-2018 12:46:12

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @irc_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @irc_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before irc_gui is made visible.
function irc_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to irc_gui (see VARARGIN)
...
% Choose default command line output for irc_gui
...
try
    [vcVer, vcDate] = irc('version');
    set(handles.textVersion, 'String', sprintf('%s (%s)', vcVer, vcDate));
catch
    ;
end
...
% UIWAIT makes irc_gui wait for user response (see UIRESUME)
% uiwait(handles.Fig_gui);


% --- Outputs from this function are returned to the command line.
function varargout = irc_gui_OutputFcn(hObject, eventdata, handles) 
...
S_gui = guidata(hObject);
try
    irc('spikesort', S_gui.vcFile_prm);
...
vcFile_prm = irc('makeprm', csAns{1}, csAns{2}, csAns{3});
...
% --- Executes during object creation, after setting all properties.
function btnSpikesort_CreateFcn(hObject, eventdata, handles)
% hObject    handle to btnSpikesort (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
